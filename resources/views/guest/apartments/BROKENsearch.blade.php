                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-4 col-md-8  col-sm-12 p-0">
                                ...
                                <input id="search" type="search" class="address-input form-control search-slt" name="address" placeholder="Dove vuoi andare?" />
                            </div>
                            <div class="col-lg-1  col-md-2 col-sm-3 p-0">

                                <input id="radius" class="form-control search-slt" type="number" name="radius" min="1" max="50" placeholder="Mq">
                            </div>
                            <div class="col-lg-1 col-md-2 col-sm-3 p-0">

                                <input id="rooms" class="form-control search-slt" type="number" name="rooms" min="0" max="10" placeholder="Stanze">
                            </div>
                            <div class="col-lg-1 col-md-2 col-sm-3 p-0">

                                <input id="beds" class="form-control search-slt" type="number" name="beds" min="1" max="20"  placeholder="Letti">
                            </div>
                            <div class="col-lg-1 col-md-2 col-sm-3 p-0">

                                <input id="baths" class="form-control search-slt" type="number" name="baths" min="1" max="20" placeholder="Bagni">
                            </div>
                            ...
                            <div class="col-lg-4 col-md-2  col-sm-12 p-0">
                                ...
                                <button id="search-button" class="btn btn-danger wrn-btn">Search</button>
                            </div>
                        </div>
                    </div>
                </div>
